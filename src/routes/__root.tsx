...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Velora POS" },
      { name: "description", content: "A modern point of sale experience for Velora Mart." },
      { name: "author", content: "Velora" },
      { property: "og:title", content: "Velora POS" },
      { property: "og:description", content: "A modern point of sale experience for Velora Mart." },
